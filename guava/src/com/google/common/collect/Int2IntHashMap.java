 ...
 */
public class Int2IntHashMap extends AbstractMap<Integer,Integer> implements Map<Integer, Integer>, Serializable,Cloneable
{
    ...
    public Int2IntHashMap() {
        this(MIN_CAPACITY, Hashing.DEFAULT_LOAD_FACTOR, Integer.MIN_VALUE);
    }
